...
// creo un array di generi;
$genres =[];
// faccio un ciclo per recuperare il disco corrente
foreach ($dischi as $disco) {
    // recupero il genere del disco corrente
    $genre = $disco['genre'];
    if(!in_array($genre, $genres)){
        // se non c'è lo pusho nell'array
        $genres[]=$genre;
    }
}
